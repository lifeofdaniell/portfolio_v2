...
const AboutPage = () => {
  const data = useStaticQuery(graphql`
    query MyQuery {
      file(relativePath: { eq: "Resume_Areola_Daniel.pdf" }) {
        id
        publicURL
        name
      }
    ...
    <div>
      ...
      <div className="about">
        ...
        <h4>
          ...
          screen designs and beautiful images. I specialize in creating
          functional user interfaces and making the user experience as
        ...
        <p>
          ...
          graphics design and photography to user interface and experience
          design and most recently, front-end development .
        </p>
      </div>
      <div className="tools">
        <h3> SOFTWARE {"&"} TECHNOLOGIES </h3>
        <p>
          Here are some of the design software packages, programming languages
          and frameworks that I use frequently. I'm always looking to learn new
          things everyday!
        </p>
